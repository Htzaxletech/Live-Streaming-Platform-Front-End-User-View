			...
			<Tooltip.Root>
					...
					<div className="flex px-3 cursor-pointer w-full py-2">
						...
						<div className="flex justify-between">
							<div className="flex flex-col">
								<span className="text-foreground font-bold text-[15px] text-start">
									{name}
								</span>
								<span className="text-foreground-secondary text-[13px] text-start">
									{category}
								</span>
							</div>
							{liveStatus ? (
								<div className="flex justify-center items-center absolute right-3">
									...
									<span className="text-foreground text-sm text-[14px]">
										{/* {viewers.toFixed(1)}k */}
										{viewers}
									</span>
								</div>
							) : (
								<div className="text-foreground-secondary text-sm absolute right-3">
									offline
								</div>
							)}
						</div>
				...
				<Tooltip.Portal>
					...
					>
						...
						<div className="text-justify text-base">{viewers}</div>
					</Tooltip.Content>
				</Tooltip.Portal>
			</Tooltip.Root>
		</Tooltip.Provider>
