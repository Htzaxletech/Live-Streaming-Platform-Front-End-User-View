    ...
    <Tooltip.Provider delayDuration={50}>
      <Tooltip.Root>
        ...
        <Link to="" target="_blank" rel="noopener noreferrer">
          ...
          <Tooltip.Portal>
          <Tooltip.Content sideOffset={15} align="center" side="right" className="bg-background-base px-3 py-2 text-base z-40 rounded-md text-foreground">
          <div className="text-primary">Helllo World Helllo WorldHelllo World</div>
