      ...
      <div className="col-span-4 grid grid-cols-1">
        <div className="flex flex-col p-4 rounded-md gap-1">
          ...
          <p>
            ...
            excepturi aliquam explicabo nihil eligendi repellat sit ea
            cupiditate. Pariatur mollitia eius a! Aspernatur est eius odit
            doloremque, asperiores maxime quos.
          </p>
          <div className="mt-3">
