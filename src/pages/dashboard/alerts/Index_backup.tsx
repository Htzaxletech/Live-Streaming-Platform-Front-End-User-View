...
const Alerts = () => {
	...
	return (
		<div className="flex flex-col h-screen mt-[18px]">
			...
			{/* Main content */}
			{/* <div className="flex flex-grow sticky top-[102px] overflow-hidden"> */}
			<div className="flex flex-grow">
				...
				<div className="flex-grow bg-gray-200">
					<div className="container bg-background-body h-full w-full max-w-full flex justify-center items-center">
						<div
